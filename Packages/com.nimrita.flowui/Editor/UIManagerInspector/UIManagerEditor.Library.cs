...
public class CodePreviewWindow : EditorWindow
{
    ...
    private void DrawCodeEditor()
    {
        ...
        float contentWidth = position.width - (showLineNumbers ? leftMargin : 0) - 30;
        float contentHeight = lineCount * 18 + 20;
        ...
        if (showLineNumbers)
        {
            ...
            {
                float yPos = 28 + (i * 18) - scrollPosition.y;
                if (yPos >= 28 && yPos < 28 + codeRect.height)
                {
                    GUI.Label(
